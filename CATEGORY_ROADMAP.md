...
**Completeness coverage (preview vs full multi-page) — updated Session 41:**
- **Full multi-page websites:** **9 of 20 templates** (cardio, dermatologia-elite-roma via specialist reuse, gusto-fine-dining, pragma-corporate-suite, elevate-startup-landing, chiara-portfolio-creativo, pixel-portfolio-fotografico, **bottega-shop-artigianale, luxe-fashion-store**) — all 9/9 multilingual (5 locales + RTL).
- **Preview-PNG-only templates:** 11 of 20. Marketplace shows the 9 live templates only; the other 11 are `tier=draft` and hidden from the public catalog per D-055/D-057.
