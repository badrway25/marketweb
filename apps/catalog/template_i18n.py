...
CHROME_I18N: dict[str, dict[str, str]] = {
    ...
    "it": {
        ...
        "mp_other_agency":    "Altri template agency →",
        "mp_other_lawyer":    "Altri studi legali →",
        "mp_other_realestate":"Altre agenzie immobiliari →",
        "mp_language":      "Lingua",
    ...
    "en": {
        ...
        "mp_other_agency":    "More agency templates →",
        "mp_other_lawyer":    "More law firm templates →",
        "mp_other_realestate":"More real estate templates →",
    ...
    "fr": {
        ...
        "mp_other_agency":    "Autres studios / agences →",
        "mp_other_lawyer":    "Autres cabinets d'avocats →",
        "mp_other_realestate":"Autres agences immobilières →",
        "mp_language":      "Langue",
    ...
    "es": {
        ...
        "mp_other_agency":    "Más estudios / agencias →",
        "mp_other_lawyer":    "Más despachos de abogados →",
        "mp_other_realestate":"Más inmobiliarias →",
        "mp_language":      "Idioma",
    ...
    "ar": {
        ...
        "mp_other_agency":    "← استوديوهات / وكالات أخرى",
        "mp_other_lawyer":    "← مكاتب محاماة أخرى",
        "mp_other_realestate":"← وكالات عقارية أخرى",
        "mp_language":      "اللغة",
        "foot_studio":      "العيادة",
        "foot_pages":       "الصفحات",
