...
- **Favicon:** `/favicon.ico`
- **Site URL:** `http://127.0.0.1:8731/templates/business/pragma-corporate-suite/preview/`
- **Brand color:** `#f59e0b`
...
- `fonts/Merriweather-ExtraBold.ttf`
- `fonts/Merriweather-Light.ttf`
- `fonts/Merriweather-Medium.ttf`
- `fonts/Merriweather-Regular.ttf`
- `fonts/Merriweather-SemiBold.ttf`
