...
- **Type pairing** — Georgia for body/UI text, IBM Plex Sans for headings/display. Never introduce a third typeface.
...
| Border | `--border` | `#6e5e52` | Dividers, card borders |
...
| Body | IBM Plex Sans | 11px | 400 |
| Caption | IBM Plex Sans | 12px | 400 |

### Typography Rules

- Body/UI: **Georgia**, Headings: **IBM Plex Sans** — these are the only display fonts
...
- **No extra fonts** — only Georgia and IBM Plex Sans are allowed
...
3. **Set typography** — Georgia, IBM Plex Sans only, using the type scale
...
- **Favicon:** `/favicon.ico`
- **Site URL:** `http://127.0.0.1:8731/templates/business/fiscus-commercialista/preview/`
- **Brand color:** `#f59e0b`
...
| border | `#6e5e52` | border | Dividers, card borders, outlines |
...
| primary | `#1f2937` | unknown | Palette color |
...
- Use **Georgia** for body/UI text, **IBM Plex Sans** for display/headings
...
- Pair **Georgia** (body) with **IBM Plex Sans** (display) — these are the only allowed fonts
...
- Don't introduce additional font families beyond Georgia and IBM Plex Sans
...
Ghost: bg transparent, border #6e5e52
Padding: 8px 16px
Radius: 6px
...
- `fonts/IBMPlexSerif-ExtraLight.ttf`
- `fonts/IBMPlexSerif-Light.ttf`
- `fonts/IBMPlexSerif-Medium.ttf`
- `fonts/IBMPlexSerif-Regular.ttf`
- `fonts/IBMPlexSerif-SemiBold.ttf`
- `fonts/IBMPlexSerif-Thin.ttf`
